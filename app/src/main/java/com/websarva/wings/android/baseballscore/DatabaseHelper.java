...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        sb.append("daritu NUMERIC DEFAULT --");
        ...
        sb.append("syuturuiritu NUMERIC DEFAULT --");
        sb.append("ops NUMERIC DEFAULT --");
        sb.append("tyoudaritu NUMERIC DEFAULT --");
        ...
        sb.append("bougyoritu NUMERIC DEFAULT --");
        sb.append("touruisasu INTEGER DEFAULT 0");
        sb.append("syubiritu NUMERIC DEFAULT --");
